<template>
  <div class="shopcart" :class="{ highligh: totalCount > 0 }">
    <div class="shopcart-wrapper">
      ...
      <div class="content-left">
        ...
        <div class="desc-wrapper">
          <p v-show="totalCount" class="total-price">￥{{ totalPrice }}</p>
      ...
      <!-- 购物车列表 -->
      <div v-show="listShow" class="shopcart-list" :class="{ show: listShow }">
        <div v-if="poiInfo.discounts2" class="list-top">
            ...
            <li v-for="(food, index) in selectFoods" :key="index" class="food-item">
              <div class="desc-wrapper">
                <div class="desc-left">
                  ...
                  <div v-show="!food.description" class="unit">{{ food.unit }}</div>
                  <div v-show="!food.unit" class="description">{{ food.description }}</div>
                </div>
    ...
    <div v-show="listShow" class="shopcart-mask" @click="hideMask"></div>
  </div>
</template>
<script>
