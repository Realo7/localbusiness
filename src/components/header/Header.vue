<template>
  <div class="header">
    ...
    <div class="bulletin-wrapper">
      <img v-if="poiInfo.discounts2" class="icon" :src="poiInfo.discounts2[0].icon_url" />

      <span v-if="poiInfo.discounts2" class="text">{{ poiInfo.discounts2[0].info }}</span>
      <div v-if="poiInfo.discounts2" class="detail" @click="showBulletin">
    ...
    <transition name="bulletin-detail">
      <div v-show="isShow" class="bulletin-detail">
        <div class="detail-wrapper">
          ...
          <div class="main-wrapper" :style="detail_bg">
            ...
            <div v-if="poiInfo.discounts2" class="discounts">
              <p>
