<template>
  <transition name="food-detail">
    <div v-show="showFlag" ref="foodView" class="food">
      <div class="food-wrapper">
        <div class="food-content">
          ...
          <div class="content-wrapper">
            ...
            <img v-show="food.product_label_picture" class="product" :src="food.product_label_picture" />
            <p class="price">
            ...
            <div v-show="!food.count || food.count === 0" class="buy" @click="addProduct">选规格</div>
          </div>
        </div>
        <Split></Split>
        <!--外卖评价-->
        <div class="rating-wrapper">
          ...
          <div class="rating-title">
            <div v-if="food.rating" class="like-ratio">
            ...
            <div v-if="food.rating" class="snd-title">
              <span class="text">{{ food.rating.snd_title }}</span>
              <span class="icon icon-keyboard_arrow_right"></span>
            </div>
          </div>
          <ul v-if="food.rating" class="rating-content">
            <li v-for="(comment, index) in food.rating.comment_list" :key="index" class="comment-item">
              <div class="comment-header">
                ...
                <img v-if="!comment.user_icon" src="./img/anonymity.png" />
              </div>
