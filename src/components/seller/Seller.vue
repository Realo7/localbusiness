<template>
  <div ref="sellerView" class="seller">
    <div class="seller-wrapper">
      ...
      <div class="seller-view">
        ...
        <div v-if="seller.poi_env" ref="picsView" class="pics-wrapper">
          <ul ref="picsList" class="pics-list">
            <li
      ...
      <div class="other-wrapper">
        <div class="server-wrapper">
          商家服务
          <div v-for="(item, index) in seller.poi_service" :key="index" class="poi-server">
            <img :src="item.icon" /> {{ item.content }}
          </div>
        </div>
        <div class="discounts-wrapper">
          <div v-for="(item, index) in seller.discounts2" :key="index" class="discounts-item">
            <div class="icon">
