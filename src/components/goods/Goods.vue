<template>
  <div class="goods">
    ...
    <div ref="menuScroll" class="menu-wrapper">
      <ul>
        <li class="menu-item" :class="{ current: currentIndex === 0 }" @click="selectMenu(0)">
          <p class="text">
            <img v-if="container.tag_icon" class="icon" :src="container.tag_icon" />
            {{ container.tag_name }}
          </p>
        </li>
        ...
        >
          ...
          <i v-show="calculateCount(item.spus)" class="num">
    ...
    <!-- 商品详情 -->
    <app-product-detail ref="foodView" :food="selectFood"></app-product-detail>
  </div>
</template>
